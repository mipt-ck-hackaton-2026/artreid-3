...
public class SlaMetricsRepository {
    ...
    private ManagerDeliverySlaResponseDTO.MetricDetails mapMetricDetails(java.sql.ResultSet rs, String prefix, int threshold, int[] bounds) throws java.sql.SQLException {
        long total = rs.getLong(prefix + "_total");
        long met = rs.getLong(prefix + "_met");
        long breach = rs.getLong(prefix + "_breach");

        return ManagerDeliverySlaResponseDTO.MetricDetails.builder()
